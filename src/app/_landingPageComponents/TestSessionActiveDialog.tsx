...
export const TestSessionActiveDialog = ({ open, setOpen }: WarningDialogProps) => {
  return (
          ...
          >
            <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
              <div className="flex items-center flex-col md:flex-row md:items-start">
                ...
                <ClockCountdown size={32} className="text-gray-900"/>
                </div>
                <div className="text-center mt-4 md:mt-0 md:ml-4 sm:text-left">
                  <div>
                    <p className="text-sm text-gray-500">
                      Bir saat içinde yalnızca bir kez teste başlayabilirsiniz.
                      Süreniz henüz dolmadığı için şu anda yeni bir test
                      başlatamazsınız. Lütfen daha sonra tekrar deneyin.
                    </p>
                  </div>
                </div>
              </div>
